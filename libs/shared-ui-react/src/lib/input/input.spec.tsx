...
describe("when rendered with a String Calculator Input", () => {
  it("should render String Calculator Input", async () => {

    const handleChange = jest.fn();
    const props: StringCalculatorInputProps = {
        id: 'component-id',
        value: 'hello',
        handleChange,
        eventName: 'component-event',
    ...
    try{
        const { container, baseElement, getByTestId } = render(<StringCalculatorInput {...props} />); 
  ...
  it("should render String Calculator Input with % adornment", async () => {
    ...
    try{
        const { queryByText } = render(<StringCalculatorInput {...props} />); 
  ...
  it("should render String Calculator Input without % adornment", async () => {
